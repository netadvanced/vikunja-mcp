...
"coverageThreshold": {
  "global": {
    "branches": 77,        // Current honest coverage: 78.85%
    "functions": 76,       // Current honest coverage: 76.43%
    "lines": 86,           // Current honest coverage: 87.91%
    "statements": 86       // Current honest coverage: 87.67%
  }
}
```
